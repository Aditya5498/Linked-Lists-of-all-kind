...
printf("You have successfully created a new node in the list and the pointer is pointing to %d and the previous element is %d\n",last->next,last->prev->data);
}
...
current->next=n;
n->next=k;
printf("Successfully added a new node after %d as %d \n and the previous element is %d :-) \n\n",current->data,n->data,n->prev->data);
